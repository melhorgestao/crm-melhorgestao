-- ============================================================================
-- FIX: criar_pedido_v2 forçava socio = 'V' ou 'A' SEMPRE,
-- ignorando códigos de caixa (C1..C5) — DeFlow (C2 etc) ficava como V.
--
-- Agora aceita:
--  - 'V', 'A', 'P' (sócios)
--  - 'C1'..'C5' (caixas — case insensitive)
--  - Qualquer outro string → fallback 'V' (compat)
-- ============================================================================
...
BEGIN
  ...
  IF v_input ~ '^C[1-5]$' THEN
    v_socio := v_input;  -- código de caixa (C1..C5)
  ...
  -- Apelido do usuario logado para campo criado_por
