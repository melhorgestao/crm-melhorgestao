...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // específico na mensagem dele. NÃO detecta na RESPOSTA do agente — fazia
    // ele "alucinar" fotos (pomada/lubrificante) quando a resposta só
    // mencionava o produto sem o cliente ter pedido.
    {
