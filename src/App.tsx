...
const DadosAgentsPage = lazyWithRetry(() => import("./pages/DadosAgentsPage"));
const AgentesPage = lazyWithRetry(() => import("./pages/AgentesPage"));
              ...
              <>
                ...
                {isAdmin && (
                  <>
                    ...
                    <Route path="/dados-agents" element={<ProtectedRoute><DadosAgentsPage /></ProtectedRoute>} />
